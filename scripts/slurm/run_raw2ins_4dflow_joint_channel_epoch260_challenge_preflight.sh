#!/bin/bash
#SBATCH --job-name=raw2ins_joint_ch260_preflight
#SBATCH --nodes=1
...
#SBATCH --output=/home/pengfeig/workspace/code/NV-Raw2insights-MRI-fork/logs/%j-raw2ins-joint-ch260-preflight.out
