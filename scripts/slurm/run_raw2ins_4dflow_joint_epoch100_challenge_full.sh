#!/bin/bash
#SBATCH --job-name=raw2ins_joint_ep100_full
#SBATCH --array=0-5%6
#SBATCH --nodes=1
#SBATCH -A healthcareeng_monai
#SBATCH --partition=interactive,batch
#SBATCH --ntasks=1
#SBATCH --gpus-per-node=8
#SBATCH --time=04:00:00
#SBATCH --output=/home/pengfeig/workspace/code/NV-Raw2insights-MRI-fork/logs/%A_%a-raw2ins-joint-ep100-full.out

set -euo pipefail
: "${RUN_NAME:?Submit with --export=ALL,RUN_NAME=<preflighted-full-run-name>}"
