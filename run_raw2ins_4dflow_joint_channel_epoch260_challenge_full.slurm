#!/bin/bash
#SBATCH --job-name=raw2ins_joint_ch260_full
#SBATCH --array=0-5%6
#SBATCH --nodes=1
...
#SBATCH --output=/home/pengfeig/workspace/code/NV-Raw2insights-MRI-fork/logs/%A_%a-raw2ins-joint-ch260-full.out

set -euo pipefail
: "${RUN_NAME:?Submit with --export=ALL,RUN_NAME=<approved-full-run-name>}"
